...
# Kris Czaja, 2021-Nov-28, added structured error handling to user interaction during CD deletion 
#------------------------------------------#
...
class DataProcessor:
    ...
    # Completed: TODOne add functions for processing here
        #Moved CD deletion option 
        #Moved adding CD


    # Completed: TODOne move processing code into function
    ...
    def CDadd(CDEntry, table):
        ...
        Results in structured  error handling if ID is not an integer.
...
class FileProcessor:
    """Processing the data to and from text file"""
        # Completed: TODOne Add code here
...
class IO:
   ...
   # Completed: TODOne add I/O functions as needed
    ...
    def show_inventory(table):
     ...
     # Completed: TODOne move IO code into function
  ...
  # 3.4 process display current inventory
    ...
    # 3.5 process delete a CD
        ...
        # 3.5.2 search thru table and delete CD
            ...
            print ('Please provide ID number only \n')
            print ('Following error occured: \n')
            print (e)
            print (type(e))
            print (e.args)
